...
class Config:
    ...
    def __init__(self):
        ...
        self.Reads_quality_dir = "/mnt/iusers01/jw01/mdefscs4/scratch/master_ATAC_ChIP_analyzer/fastp_qc"
        self.cleaned_alignments_dir = "/mnt/iusers01/jw01/mdefscs4/scratch/master_ATAC_ChIP_analyzer/clean_alignments_alelle"
        self.macs2_dir = "/mnt/iusers01/jw01/mdefscs4/scratch/master_ATAC_ChIP_analyzer/macs2_allele"
        self.genrich_dir = "/mnt/iusers01/jw01/mdefscs4/scratch/master_ATAC_ChIP_analyzer/genrich_allele"
        self.coverages_dir = "/mnt/iusers01/jw01/mdefscs4/scratch/master_ATAC_ChIP_analyzer/coverages_allele"
        self.other_qc_dir = "/mnt/iusers01/jw01/mdefscs4/scratch/master_ATAC_ChIP_analyzer/qc_allele"

        self.bowtie2_index = "/mnt/jw01-aruk-home01/projects/psa_functional_genomics/NEW_references/variants/bowtie2_masked_index/bowtie2_masked_index"
